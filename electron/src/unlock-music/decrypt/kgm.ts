...
import { UNLOCK_MUSIC_VERSION } from '@unlock/constants';
...
async function LoadMaskV2(): Promise<boolean> {
  let mask_url = `https://cdn.jsdelivr.net/gh/unlock-music/unlock-music@${UNLOCK_MUSIC_VERSION}/public/static/kgm.mask`;
